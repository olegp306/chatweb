...
import UsersListWithCheck from '../../ChatUsersList/UsersListWithCheck';
import UsersList from '../../ChatUsersList/UsersList';


export default  class BigChatInfo extends Component {
  constructor(props) {
    super(props);
